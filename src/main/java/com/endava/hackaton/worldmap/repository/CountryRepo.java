...
public interface CountryRepo extends JpaRepository<Country, Long> {
    ...
    @Query(value = "SELECT t2.aqi, t2.temperature, t2.pressure, t2.humidity, t2.wind FROM worldmapdb.countries t1 JOIN worldmapdb.measurements t2 ON t1.country_measurement_id = t2.id where name = :name LIMIT 1", nativeQuery = true)
